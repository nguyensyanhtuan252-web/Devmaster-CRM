...
namespace ITPRO_CRM.Data
{
    public class ITPRO_CRMContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Cấu hình: Xóa Giảng viên thì Lớp học KHÔNG bị xóa theo (chỉ set GiangVienId = null)
            ...
            // Cấu hình: Xóa Khóa học thì Lớp học KHÔNG bị xóa theo (chỉ set KhoaHocId = null)
            modelBuilder.Entity<LopHoc>()
                .HasOne(l => l.KhoaHoc)
                .WithMany()
